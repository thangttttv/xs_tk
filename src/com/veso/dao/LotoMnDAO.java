...
public class LotoMnDAO {
	...
	public static void main_ts_nb(String[] args) {
		...
		LotoMnDAO lotoDAO = new LotoMnDAO("thongke_loto_mienbac");
	...
	public static void main(String[] args) {
		...
		LotoMnDAO lotoDAO = new LotoMnDAO("thongke_loto_miennam");
	...
	public static void main9(String[] args) {
		LotoMnDAO lotoDAO = new LotoMnDAO("thongke_loto_mientrung");
		ProvinceDAO provinceDAO = new ProvinceDAO();
