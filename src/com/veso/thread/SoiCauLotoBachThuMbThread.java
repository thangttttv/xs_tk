...
public class SoiCauLotoBachThuMbThread {
	private static Logger logger = new Logger("SoiCauLotoBachThuMbThread");
	...
	public boolean createBuocCauMienBac(String boso,int x, int y, long bien_ngay, int buoc,int loaicau, int songay,BuocCauBean buocCauBean)
	{
		...
		if(lotoDAO.checkLotoMienBacBachThu(open_date, boso)>0)
		{
			if(songay==buoc)
			{
	...
	public static void main(String[] args) {
		...
		// Tao cau
		SoiCauLotoBachThuMbThread soiCauHaiNgayThread = new SoiCauLotoBachThuMbThread();
		...
		while (k<so_ngay.length)
		{
			...
			soiCauBean.setType(4);// soi cau loto
