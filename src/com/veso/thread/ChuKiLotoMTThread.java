...
public class ChuKiLotoMTThread {
	private static Logger logger = new Logger("ChuKiLotoMTThread");
	public static void main(String[] args) {	
		
		logger.log("Chu ki loto Mien Trung ngay "+Calendar.getInstance().get(Calendar.DAY_OF_MONTH)+"/"+(Calendar.getInstance().get(Calendar.MONTH)+1)+"/"+Calendar.getInstance().get(Calendar.YEAR));
